            ...
            <div class="middle-right-table">
                <table class="table table-bordered li11">
                    ...
                    <tr>
                        ...
                        <td>
                            <button class="btn-success li111">添加</button>
                        </td>
                    </tr>
                </table>
                ...
                <table class="table table-bordered li21">
                    ...
                    <tr>
                        ...
                        <!--图片上传-->
                        <form id="uploadForm" enctype="multipart/form-data" action="/InsertProduct" method="post">
                            <td><input class="form-control col-lg-6" type="file" name="file"></td>
                        </form>
                        <td>
                            <button class="li211 btn-success">添加</button>
                        </td>
